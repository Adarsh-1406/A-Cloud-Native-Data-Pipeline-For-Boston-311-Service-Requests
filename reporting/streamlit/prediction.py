...
st.page_title="PREDICT 311", 
st.page_icon="https://play-lh.googleusercontent.com/-ei9jmjQa4C0dLIciwW3BF9Ym0M7_tjJlmlrDX3SxPQ7y5qflwWUsaGxuRzZyJBFZwg",  # Local icon path or URL if hosted online
st.layout="wide"
